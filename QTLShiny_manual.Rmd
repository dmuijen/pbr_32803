...
The summary pane gives a summary of the cross file, including the number of samples, markers and chomosomes.
...
##Graphical genotype
The subtab "Graphical genotype" shows the graphical genotype of all markers on all chromosomes for all individuals. To generate the plot press the "Plot table" button. Markers colored red and blue correspond to parent A and parent B respectively. White and green entries correspond respectively to missing values and heterozygous markers. 
